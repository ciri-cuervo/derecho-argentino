...
Existe por un modo de fallar especifico: cuando falta `pdftotext`, el auditor de fechas
metia el `FileNotFoundError` en el mismo `except` que usa para un PDF roto y seguia. El
resumen final decia `0 A REVISAR` con el auditor apagado -- en una maquina sin poppler, los
64 fallos pasaban sin mirarse y el codigo de salida era 0.
...
# Que instalar, por plataforma. Se nombra el proyecto ademas del paquete porque los nombres
...
COMO = {
    "poppler": {
        ...
        "linux": "apt install poppler-utils   (o el equivalente de tu distribucion)",
...
def falta(binario: str) -> bool:
    """True si el binario no esta en el PATH. En Windows shutil.which respeta PATHEXT."""
