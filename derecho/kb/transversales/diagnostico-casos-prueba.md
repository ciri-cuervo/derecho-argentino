# Casos de prueba · kb/transversales/diagnostico-SKILL.md
...
> Uso: pegar el escrito de prueba en una sesión con `kb/transversales/diagnostico-SKILL.md` cargado
...
1. Cargar `kb/transversales/diagnostico-SKILL.md` + el perfil de área correspondiente.
...
- Cambie la estructura de secciones del `kb/transversales/diagnostico-SKILL.md`
- Se modifiquen los marcadores canónicos en `kb/marcadores-GLOSARIO.md`
...
Registrar cualquier actualización en `kb/CHANGELOG.md`.
