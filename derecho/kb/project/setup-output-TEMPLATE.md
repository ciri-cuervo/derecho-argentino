...
Perfil específico: ver `argentina/kb/perfiles/laboral-CLAUDE.md` y `argentina/kb/ejemplos/ejemplos-laboral.md`.
...
Perfil específico: ver `argentina/kb/especialidades/medicina-legal-CLAUDE.md`.
...
Perfil específico: ver `argentina/kb/perfiles/societario-CLAUDE.md` y `argentina/kb/ejemplos/ejemplos-societario.md`.
...
Las reglas del CLAUDE.md base aplican íntegramente. Ver `argentina/kb/project/CLAUDE.md`
sección "Reglas de citación".

El glosario canónico de marcadores está en `argentina/kb/marcadores-GLOSARIO.md`.
