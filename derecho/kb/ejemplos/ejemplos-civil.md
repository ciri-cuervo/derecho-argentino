...
> Archivo complementario de `kb/perfiles/civil-CLAUDE.md`.
...
| Fuero laboral (CNAT) | No aplica directamente | En materia laboral la cuantificación de incapacidad por accidente de trabajo se rige por la Ley 26.773 (prestaciones LRT) o por la acción civil del art. 1072/1749 CCCN si se optó por esa vía. Ver `kb/ejemplos/ejemplos-laboral.md` Ejemplo 4. | Ver `kb/ejemplos/ejemplos-laboral.md` |
...
- Citación en garantía: presentarla junto con la demanda. Si la aseguradora alega
  ...
  (Cuello, Fallos 330:3483; Buffoni, Fallos 337:329; ver kb/doctrina/civil-DOCTRINA.md). Verificar
...
Tope móvil en CBT del INDEC (art. 47 inc. b LDC, texto Ley 27.701); ver kb/perfiles/consumidor-CLAUDE.md.
...
*Para fallos de referencia por instituto, ver `kb/doctrina/civil-DOCTRINA.md` (leading cases verificados).*
