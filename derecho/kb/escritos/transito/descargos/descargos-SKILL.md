...
> Opera bajo el perfil argentina/kb/perfiles/transito-CLAUDE.md. Leer ese perfil antes de redactar.
...
Elegir el modelo según la causal, en kb/escritos/transito/descargos/modelos/:

- kb/escritos/transito/descargos/modelos/modelo-01-nulidad-formal.md - defectos del acta y fotomultas.
- kb/escritos/transito/descargos/modelos/modelo-02-urgencia-fuerza-mayor.md - estado de necesidad acreditado.
- kb/escritos/transito/descargos/modelos/modelo-03-denuncia-de-venta.md - vehículo enajenado antes del hecho.
- kb/escritos/transito/descargos/modelos/modelo-04-falta-notificacion-prescripcion.md - notificación tardía o prescripción.
- kb/escritos/transito/descargos/modelos/modelo-05-error-identificacion.md - dominio o titular mal consignados; cesión de uso en flotas.
- kb/escritos/transito/descargos/modelos/modelo-06-recurso-apelacion.md - recurso contra la resolución que confirma la sanción.
- kb/escritos/transito/descargos/modelos/modelo-07-defensa-a-distancia-art71.md - modalidad de defensa por escrito a distancia (más de 60 km, art. 71 párr. 1); envuelve la causal de fondo.
