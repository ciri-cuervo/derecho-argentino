...
> perfil de área específica cuando corresponda (kb/perfiles/civil-CLAUDE.md para daños, kb/perfiles/penal-CLAUDE.md para
> usurpación de identidad, kb/perfiles/administrativo-CLAUDE.md para la AAIP como organismo de control).
...
- **Ley 24.240 (Defensa del Consumidor):** aplicable cuando el reclamo se vincula con un contrato de
  ...
  plantearlas por separado. Ver kb/perfiles/civil-CLAUDE.md sección de daños en consumo.
...
- **Art. 173 inc. 16 CP** (defraudación informática) y figuras conexas de la Ley 26.388 (delitos
  ...
  o tarjeta con identidad usurpada. Ver kb/perfiles/penal-CLAUDE.md sección "Delitos informáticos".
...
apertura de cuenta, pérdida de una oportunidad comercial). Ver kb/perfiles/civil-CLAUDE.md sección de daños para
...
- Si hay relación de consumo conexa (tarjeta de crédito, préstamo personal de una entidad financiera
  ...
  kb/perfiles/civil-CLAUDE.md para la lógica de cuantificación.
