...
> Complementa el perfil general (argentina/kb/project/CLAUDE.md) con lógica específica de práctica penal.
...
**Jurisprudencia cargada (ver kb/doctrina/penal-DOCTRINA.md; verificar texto íntegro antes de transcribir):**
...
- Delitos imprescriptibles: crímenes de lesa humanidad (CSJN, "Arancibia Clavel", Fallos 327:3312, y "Simón", Fallos 328:2056; ver kb/doctrina/penal-DOCTRINA.md, sección 8). Verificar si el caso involucra esta categoría
...
```
Doctrina cargada: CSJN, "Acosta, Alejandro Esteban", Fallos 331:858 (23/4/2008) - tesis amplia del art. 76 bis; procedencia cuando se reúnen los presupuestos legales. Ver kb/doctrina/penal-DOCTRINA.md. Verificar el texto íntegro antes de transcribir considerandos.
```
...
Jurisprudencia cargada (ver kb/doctrina/penal-DOCTRINA.md; verificar texto íntegro antes de transcribir): CSJN "Charles Hermanos", "Montenegro", "Fiorentino", "Rayford", "Ruiz", "Daray", "Quaranta" - regla de exclusión y fruto del árbol envenenado. Para la recepción de las excepciones:
```
...
Acción y probation: delitos de acción pública. La probation se deniega en hechos calificados como violencia de género (CSJN "Góngora", Fallos 336:392; ver kb/doctrina/penal-DOCTRINA.md y la sección de suspensión del proceso a prueba). Discutir primero la calificación del hecho.
...
```
Doctrina cargada: CSJN, "Verbitsky, Horacio s/ hábeas corpus", Fallos 328:1146 (3/5/2005) - hábeas corpus colectivo correctivo, condiciones de detención y remedio estructural. Ver kb/doctrina/penal-DOCTRINA.md. Verificar el texto íntegro antes de transcribir considerandos.
```
...
- `kb/doctrina/penal-DOCTRINA.md`: leading cases verificados por instituto (probation, estupefacientes, recursos, hábeas corpus, prisión preventiva, exclusión probatoria, jurados).
- `kb/ejemplos/ejemplos-penal.md`: escenarios de práctica anotados.
- `kb/escritos/penal/escritos/escritos-penal-SKILL.md` y `kb/escritos/penal/escritos/modelos/`: skill orquestador y modelos (excarcelación o cese de prisión preventiva, suspensión del juicio a prueba, hábeas corpus correctivo, nulidad de allanamiento, recurso de casación).
