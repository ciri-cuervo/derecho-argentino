...
> Complementa el perfil general (argentina/kb/project/CLAUDE.md) y el perfil administrativo nacional (kb/perfiles/administrativo-CLAUDE.md) con lógica específica del fuero contencioso administrativo de [PROVINCIA].
...
Las reglas generales del CLAUDE.md argentino y del kb/perfiles/administrativo-CLAUDE.md nacional aplican íntegramente. Específicas para este fuero provincial:
