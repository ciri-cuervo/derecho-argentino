# Laboral · el contrato vigente cuando la prestación se interrumpe
...
**Salió de `laboral.md` y conserva su numeración** —5.13, 5.14 y 5.15 con sus subsecciones—, que
es global y estable: quien viene de una remisión llega igual.

**El corte es por materia.** Acá el contrato **sigue vivo** y lo que se interrumpe es la
prestación: la licencia por maternidad y la excedencia, la enfermedad inculpable con su reserva
del puesto, y la suspensión que dispone el empleador con su poder disciplinario. En `laboral.md`
el eje es el otro: cómo termina el contrato y cuánto se paga.

**Las dos se cruzan en un punto que hay que mirar de los dos lados:** un despido durante una
licencia o una suspensión no se resuelve con este módulo ni con `laboral.md` por separado. La protección y los
plazos están acá; la liquidación y el tramo de reforma aplicable, en `laboral.md` 5.1 y 5.10.
...
## 5.15 bis Lo que este módulo NO hace

**No cubre la extinción ni su liquidación** —`laboral.md` 5.1 a 5.4, 5.12 y el orden de cálculo de
5.10—, **ni los principios y el orden público laboral** que deciden si una cláusula vale o si un
acuerdo libera, que están en `laboral.md` 5.16 y pesan en cualquiera de las dos materias.

**No cubre el accidente ni la enfermedad PROFESIONAL**, que es el otro sistema: ésos van por la
Ley 24.557 y están en `laboral-riesgos.md` 5.8. La frontera es el origen del daño — inculpable
acá, laboral allá—, y confundirla cambia la vía, el plazo y quién paga.

**Ni el proceso**: en PBA manda `sede-judicial-pba.md` 1.6, y en la justicia nacional
`laboral.md` 5.9.
