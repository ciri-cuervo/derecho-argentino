...
- `derecho/fuentes/ccyc-comentado/INDICE.md` — comentario oficial del CCyCN por artículo.
- `derecho/fuentes/MANIFIESTO.md` — qué está cargado y qué está pendiente.
...
El ruteo detallado por tipo de consulta está en `derecho/kb/transversales/fuentes-y-conectores.md` del repo: tabla de
...
No abrir los PDFs a ciegas: **`derecho/fuentes/ccyc-comentado/INDICE.md` rutea cada rango de
