# Riesgos del trabajo · Ley 24.557 y su sistema
...
**Salió de `laboral.md` y conserva su numeración**, que es global y estable: quien viene de una
remisión a 5.8 o a 5.8.3 llega igual. El corte es por materia, no por tamaño: acá el régimen es
**otra ley** —la 24.557 y sus reformas—, con su propia instancia administrativa previa, su propio
baremo y su propia jurisprudencia, y el eje no es la extinción del contrato sino la reparación de
un daño. Una consulta por despido no lo abre; una por accidente o enfermedad profesional abre
esto y **no necesita** los institutos de fondo de `laboral.md`.

**Lo que queda en `laboral.md`:** el régimen del contrato y su extinción. **Lo que se cruza:** si
además del accidente hay despido, se leen los dos, y el orden lo fija `laboral.md` 5.10.
...
## 5.8 bis Lo que este módulo NO hace

**No cubre la extinción del contrato ni su liquidación**: eso es `laboral.md` 5.1 a 5.4 y 5.12,
y el orden de cálculo está en 5.10. **No cubre el proceso**: en PBA manda `sede-judicial-pba.md`
1.6 y en la justicia nacional `laboral.md` 5.9. **No cubre el control del dictamen médico como
prueba** —baremo aplicado, estudios complementarios, qué transcribió el perito del relato—, que
está en `prueba-pericial.md` 20.

**Tampoco cubre la HOMOLOGACIÓN del acuerdo ante la Comisión Médica** —art. 4 de la Ley 27.348,
que le da autoridad de cosa juzgada administrativa en los términos del art. 15 LCT y manda poner
las prestaciones a disposición dentro de los cinco días—. Está declarado acá y no suplido:
`[VERIFICAR VIGENCIA: efectos del acto homologatorio del art. 4 de la Ley 27.348 y su alcance como cosa juzgada administrativa - este módulo no lo desarrolla]`

**Y no trae montos.** Los del sistema se actualizan por semestre y salen del marcador, no de la
memoria: ver 5.8.5.
