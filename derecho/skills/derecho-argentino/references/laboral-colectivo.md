# Laboral colectivo · convenios, sindicatos y conflicto
...
Cotejado contra `fuentes/normas/ley-14250.txt`, `fuentes/normas/ley-23551.txt` con su
**Decreto reglamentario 467/1988**, y `fuentes/normas/ley-14786.txt`.

**Es la otra mitad de `laboral.md`, y se consulta por otra cosa.** Allá el sujeto es el trabajador
individual y el eje es la extinción; acá el sujeto es **el colectivo** —el sindicato, la unidad de
negociación, la asamblea— y el eje es el convenio y el conflicto. Las dos remiten entre sí: el CCT
que se aplica a una liquidación se determina con 5.17, y la injuria durante una medida de acción
directa se encuadra por el art. 242 LCT, en `laboral.md` 5.12.3.

**Conserva la numeración de origen**, 5.17 y 5.18, porque las remisiones de otros módulos apuntan
a esos números y la numeración de este repositorio es global.

---

## 5 · Laboral — colectivo

Es el mismo capítulo 5 que `laboral.md`, porque la numeración de este repositorio es global:
las secciones conservan su número y las remisiones de otros módulos siguen valiendo.
...
> acumulable con el art. 245 bis LCT**. Es una descripción prerreforma presentada como vigente.
...
se resuelven según `sede-judicial-pba.md` 1.6.1, que es el que dice qué código rige.
