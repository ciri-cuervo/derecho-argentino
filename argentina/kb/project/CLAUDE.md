...
Para completarlos: ver argentina/kb/project/setup-interview.md.
...
Fórmula indemnizatoria base: art. 245 LCT - TRES regímenes según fecha del acto extintivo (ver kb/perfiles/laboral-CLAUDE.md)

Perfil específico: ver argentina/kb/perfiles/laboral-CLAUDE.md
...
Perfil específico: ver argentina/kb/perfiles/societario-CLAUDE.md
...
Perfil específico: ver argentina/kb/perfiles/administrativo-CLAUDE.md
Tributario
...
Perfil específico: ver argentina/kb/perfiles/tributario-CLAUDE.md
...
Flujo completo: ver argentina/kb/transversales/diagnostico-SKILL.md.
...
Detalle completo de red-flags: ver argentina/kb/contratos/red-flags.md.
...
Perfil completo: ver argentina/kb/perfiles/laboral-CLAUDE.md.
...
Insertar el marcador correspondiente según el glosario (argentina/kb/marcadores-GLOSARIO.md):
...
PerfilActivar cuando la consulta involucra...kb/perfiles/laboral-CLAUDE.mdcontrato de trabajo, despido, liquidación, accidente laboral, sindicato, CCTkb/perfiles/laboral-CLAUDE.md + kb/escritos/laboral/telegrama/telegramas-SKILL.mdtelegramas laborales, cartas documento, intimaciones, notificaciones fehacientes laboraleskb/perfiles/civil-CLAUDE.md + kb/ejemplos/ejemplos-civil.mddaños y perjuicios, responsabilidad civil, contratos civiles, prescripción civilkb/contratos/CLAUDE.md + kb/contratos/red-flags.mdrevisión o redacción de contratos (NDA, servicios, compraventa, locación, SaaS, mutuo, agencia)kb/perfiles/societario-CLAUDE.md + kb/ejemplos/ejemplos-societario.mdconstitución de sociedades, M&A, due diligence, pactos de accionistaskb/perfiles/administrativo-CLAUDE.mdrecurso administrativo, responsabilidad del Estado, contratación pública, empleo públicokb/perfiles/tributario-CLAUDE.mdARCA, TFN, IVA, Ganancias, ingresos brutos, régimen penal tributariokb/perfiles/penal-CLAUDE.mdimputado, procesado, defensa penal, querella, medidas cautelares penaleskb/especialidades/medicina-legal-CLAUDE.mdinforme médico-legal pericial, lesiones, imputabilidad, incapacidad laboral, invalidez previsional, praxis médica, amparo de salud, pericia en fuero penal / civil / seguridad socialkb/especialidades/violencia-digital-CLAUDE.mdpornovenganza, difusión no consentida de imágenes íntimas, sextorsión, hostigamiento o acoso digital, violencia digital o telemática (Ley Olimpia), usurpación de identidad digital con componente de género, violencia vincular ejercida por TICkb/perfiles/familia-CLAUDE.mddivorcio, alimentos, cuidado personal, filiación, adopción, violencia familiarkb/perfiles/concursos-CLAUDE.mdconcurso preventivo, quiebra, verificación de créditos, APE, cramdownkb/perfiles/previsional-CLAUDE.md + kb/ejemplos/ejemplos-previsional.mdreajuste de haberes, movilidad jubilatoria, haber inicial, denegatoria de beneficio de ANSES, jubilación, pensión, retiro por invalidez del SIPA, PUAM, moratoria previsional, Fuero Federal de la Seguridad Socialkb/perfiles/transito-CLAUDE.md + kb/escritos/transito/descargos/descargos-SKILL.mdmulta o infracción de tránsito, acta, fotomulta, descargo o apelación ante controlador o juez de faltas, denuncia de venta frente a infracciónkb/transversales/plazos-SKILL.mdcómputo de plazos procesales o administrativos, prescripción, caducidad, ferias judiciales, SECLOkb/transversales/diagnostico-SKILL.mddiagnóstico previo de cualquier escrito aportado antes de modificarlokb/transversales/bucles-SKILL.mdarmar o fundamentar desde cero un escrito de fondo (demanda, contestación, recurso, alegato): bucle con criterio de salida verificable y nodo bloqueante de plazo / competencia / agotamiento antes del fondo
...
precedente - ver argentina/kb/transversales/fuentes-y-conectores.md.
...
argentina/
  ...
  kb/CHANGELOG.md                      # Historial de cambios normativos y del sistema
  kb/marcadores-GLOSARIO.md            # Glosario canónico de marcadores (fuente de verdad)
  setup-interview.md                # Entrevista de configuración inicial
  setup-output-TEMPLATE.md          # Template de output de la entrevista
  kb/transversales/diagnostico-SKILL.md              # Skill de diagnóstico previo (transversal)
  kb/transversales/diagnostico-casos-prueba.md       # Casos de prueba para verificar el skill de diagnóstico
  kb/transversales/plazos-SKILL.md                   # Skill de cómputo de plazos procesales y administrativos
  kb/transversales/bucles-SKILL.md                   # Skill de bucle de fundamentación (armado de escritos de fondo desde cero)
  kb/contratos/                         # Perfil unificado para revisión y redacción de contratos
    CLAUDE.md                          # Perfil de práctica - contratos bajo derecho argentino
    kb/contratos/red-flags.md                       # Lista de alertas para revisión de contratos (activ. automática)
    kb/contratos/indices-y-tasas.md                 # Índices, tasas de referencia y evaluación de abusividad
  kb/perfiles/administrativo-CLAUDE.md          # Perfil derecho administrativo (federal)
  kb/jurisdicciones/administrativo/                    # Perfiles jurisdiccionales (ver README.md para listado completo)
  kb/especialidades/
    kb/especialidades/medicina-legal-CLAUDE.md         # Pericia médica forense (penal / civil / seguridad social)
    kb/especialidades/violencia-digital-CLAUDE.md      # Violencia digital (Ley Olimpia): pornovenganza, sextorsión, hostigamiento digital
  kb/perfiles/civil-CLAUDE.md                   # Perfil derecho civil (CCCN)
  kb/perfiles/concursos-CLAUDE.md               # Perfil concursos y quiebras (LCQ)
  kb/perfiles/familia-CLAUDE.md                 # Perfil derecho de familia
  kb/perfiles/laboral-CLAUDE.md                 # Perfil derecho del trabajo (LCT)
  laboral/
    telegrama/
      kb/escritos/laboral/telegrama/telegramas-SKILL.md           # Instrucciones operativas del skill de telegramas
      kb/escritos/laboral/telegrama/tipos-de-telegrama.md         # Clasificación por grupo y notas críticas
      kb/escritos/laboral/telegrama/reglas-normativas.md          # Reglas de validación normativa post-reforma
      modelos/
        kb/escritos/laboral/telegrama/modelos/bloque-01-registro.md
        kb/escritos/laboral/telegrama/modelos/bloque-02-estabilidad-despido.md
        kb/escritos/laboral/telegrama/modelos/bloque-03-salarios.md
        kb/escritos/laboral/telegrama/modelos/bloque-04-ius-variandi.md
        kb/escritos/laboral/telegrama/modelos/bloque-05-renuncia.md
        kb/escritos/laboral/telegrama/modelos/bloque-06-vacaciones-licencias.md
        kb/escritos/laboral/telegrama/modelos/bloque-07-salud-hostigamiento.md
        kb/escritos/laboral/telegrama/modelos/bloque-08-construccion.md
  kb/perfiles/penal-CLAUDE.md                   # Perfil derecho penal
  kb/perfiles/previsional-CLAUDE.md             # Perfil derecho previsional (SIPA - Fuero Federal de la Seguridad Social)
  kb/perfiles/societario-CLAUDE.md              # Perfil derecho societario (LGS)
  kb/perfiles/transito-CLAUDE.md                # Perfil infracciones y multas de tránsito
  transito/
    descargos/
      kb/escritos/transito/descargos/descargos-SKILL.md            # Instrucciones operativas del skill de descargos
      modelos/                       # Modelos de descargo y recurso por causal
        kb/escritos/transito/descargos/modelos/modelo-01-nulidad-formal.md
        kb/escritos/transito/descargos/modelos/modelo-02-urgencia-fuerza-mayor.md
        kb/escritos/transito/descargos/modelos/modelo-03-denuncia-de-venta.md
        kb/escritos/transito/descargos/modelos/modelo-04-falta-notificacion-prescripcion.md
        kb/escritos/transito/descargos/modelos/modelo-05-error-identificacion.md
        kb/escritos/transito/descargos/modelos/modelo-06-recurso-apelacion.md
        kb/escritos/transito/descargos/modelos/modelo-07-defensa-a-distancia-art71.md
  kb/perfiles/tributario-CLAUDE.md              # Perfil derecho tributario
  kb/ejemplos/ejemplos-civil.md                 # Casos de daños y responsabilidad civil
  kb/ejemplos/ejemplos-discapacidad.md          # Amparo de salud, AT y reintegros - casos modelo
  kb/ejemplos/ejemplos-familia.md               # Casos modelo de familia
  kb/ejemplos/ejemplos-laboral.md               # Liquidaciones laborales - casos modelo y checklist
  kb/ejemplos/ejemplos-penal.md                 # Casos modelo penales
  kb/ejemplos/ejemplos-previsional.md           # Reajuste de haberes: haber inicial, movilidad, retroactivo e intereses
  kb/ejemplos/ejemplos-societario.md            # Due diligence y pactos de accionistas
  kb/transversales/fuentes-y-conectores.md                        # Conectores MCP y fuentes primarias
  project/legal.local.md.template   # Template de configuración local del estudio (por rama del derecho)
