...
> Complementa el perfil general (argentina/kb/project/CLAUDE.md) y el perfil administrativo nacional (kb/perfiles/administrativo-CLAUDE.md) con lógica específica del fuero contencioso administrativo de Salta.
...
**Actos de organismos federales con sede en Salta:** aplica el régimen federal (LNPA, Ley 19.549, y RLNPA, Decreto 1759/72). Ver kb/perfiles/administrativo-CLAUDE.md.
...
Las reglas generales del CLAUDE.md argentino y del kb/perfiles/administrativo-CLAUDE.md nacional aplican íntegramente. Específicas para este fuero:
