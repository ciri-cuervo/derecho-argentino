...
> Complementa el perfil general (argentina/kb/project/CLAUDE.md) con lógica específica de práctica societaria y operaciones de M&A.
...
- `argentina/kb/ejemplos/ejemplos-societario.md` - checklist de due diligence en compraventa de empresa mediana, estructura de pacto de accionistas con análisis de ejecutabilidad, y comparativo de tipos societarios. El sistema lo consulta automáticamente en operaciones de M&A, due diligence y constitución de sociedades.
- `argentina/kb/contratos/red-flags.md` - lista de alertas para revisión de contratos. El sistema lo aplica automáticamente ante cualquier contrato aportado (SPAs, pactos de accionistas, NDAs), según activación definida en `argentina/kb/project/CLAUDE.md`.

Sin `kb/ejemplos/ejemplos-societario.md` cargado: el sistema opera sin checklist estructurado de due diligence. Sin `kb/contratos/red-flags.md` cargado: el análisis de contratos societarios aplica solo las red flags del CLAUDE.md general.
...
- Tributario: Impuesto a las Ganancias reducido, IVA, deducciones aceleradas (ver cross-reference en kb/perfiles/tributario-CLAUDE.md si está disponible)
