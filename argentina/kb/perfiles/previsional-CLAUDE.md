...
> Complementa el perfil general (argentina/kb/project/CLAUDE.md) con lógica específica de práctica previsional y de seguridad social.
...
**Para redactar escritos** (no solo analizar o liquidar): usar `kb/escritos/previsional/escritos/escritos-previsional-SKILL.md`, que orquesta los modelos de `kb/escritos/previsional/escritos/modelos/` (demanda de reajuste de haberes, demanda de impugnación judicial de denegatoria, demanda de pensión derivada por conviviente) y remite a `kb/ejemplos/ejemplos-previsional.md` para la liquidación numérica.
...
- **Invalidez del SIPA** (retiro por invalidez, art. 48 Ley 24.241 [VERIFICAR VIGENCIA]): es previsional y se trata acá. La acreditación médica de la incapacidad y la pericia se rutean a `kb/especialidades/medicina-legal-CLAUDE.md`.
- **PNC por invalidez** (Ley 13.478, Decreto 432/97, Decreto 843/2024): está cubierta en `kb/perfiles/discapacidad-CLAUDE.md`, no acá. Es una prestación no contributiva con vía de impugnación, requisitos y jurisprudencia propios. Si la consulta es de PNC por invalidez, derivar a ese perfil.
...
Requiere acreditar la incapacidad en los términos del régimen (porcentaje y carácter). La determinación médica se rutea a la pericia: ver `kb/especialidades/medicina-legal-CLAUDE.md` para la prueba de la invalidez. La denegatoria por dictamen de comisión médica se impugna por la vía previsional.
...
El armado de una demanda de reajuste corre bajo `kb/transversales/bucles-SKILL.md`, rama Previsional. Resumen del criterio de cierre propio de la rama:
...
El cálculo del retroactivo de reajuste -recomposición del haber + diferencias devengadas + intereses- se desarrolla con casos modelo en `kb/ejemplos/ejemplos-previsional.md` (haber inicial, movilidad, y retroactivo con corte de prescripción e intereses), en la línea de `kb/ejemplos/ejemplos-laboral.md`. Cargar ese archivo junto con el perfil cuando la tarea sea una liquidación. Toda liquidación se arma con los marcadores de verificación de índice, tasa y monto en su lugar; ninguna cifra de haber, índice o tasa se cita sin marcador.
...
- Frontera con discapacidad: PNC por invalidez se deriva a `kb/perfiles/discapacidad-CLAUDE.md`; retiro por invalidez del SIPA se trata acá con pericia ruteada a `kb/especialidades/medicina-legal-CLAUDE.md`.
