...
> que opera sobre un escrito ya aportado. Se apoya en kb/transversales/fuentes-y-conectores.md para el ruteo de
> fuentes y en kb/marcadores-GLOSARIO.md para los marcadores y el cierre.
...
sale del perfil cargado (kb/perfiles/laboral-CLAUDE.md, kb/perfiles/civil-CLAUDE.md, etc.); este skill
...
kb/transversales/fuentes-y-conectores.md. Regla, repetida porque es la que se viola sola: la instrucción dice dónde
...
se nombran por su prefijo de tool; el detalle está en kb/transversales/fuentes-y-conectores.md.
...
- Criterio de salida: art. 245 LCT resuelto por el régimen que corresponde a la fecha
  ...
  kb/perfiles/laboral-CLAUDE.md); tope del CCT verificado o marcado; cada rubro con su norma
...
- Criterio de salida: fórmula de movilidad identificada y verificada por cada período
  ...
  DNU 274/2024) no es intercambiable (ver kb/perfiles/previsional-CLAUDE.md); índice de
