...
Opera siempre junto con el perfil `kb/perfiles/previsional-CLAUDE.md`, que aporta la lógica de fondo
(fueros, institutos, plazos de caducidad, control de topes, marcadores), y con
`kb/ejemplos/ejemplos-previsional.md`, que aporta la mecánica de liquidación (haber inicial, movilidad,
...
variable` de `kb/perfiles/previsional-CLAUDE.md` y aplicar sus reglas. Puntos críticos:
...
- Cuatro vías, no intercambiables: impugnación judicial de denegatoria (plazo de caducidad
  ...
  retroactivo (corte de cobro). Ver el cuadro comparativo en `kb/perfiles/previsional-CLAUDE.md`, sección
...
| Situación | Modelo |
|---|---|
| Reajuste de haber inicial (índice de actualización), de movilidad (fórmula por tramo), o ambos, con o sin planteo de confiscatoriedad por topes | `modelos/kb/escritos/previsional/escritos/modelos/demanda-reajuste-haberes.md` |
| ANSES denegó el otorgamiento, el reajuste o el retiro por invalidez y hay que impugnar judicialmente esa resolución | `modelos/kb/escritos/previsional/escritos/modelos/demanda-impugnacion-denegatoria.md` |
| Pensión por fallecimiento reclamada por conviviente sin matrimonio, con o sin denegatoria previa de ANSES | `modelos/kb/escritos/previsional/escritos/modelos/demanda-pension-derivada.md` |
...
`kb/ejemplos/ejemplos-previsional.md` y completar sus tablas con los datos reales del caso, sin arrastrar
...
- Jurisprudencia: prohibido citar carátula, sala, año o expediente sin material aportado o sin
  verificación vía conector. Los precedentes con cita cerrada en `kb/perfiles/previsional-CLAUDE.md`
...
- Citar un fallo con carátula y Fallos sin material ni verificación, fuera de los precedentes
  ya anclados en `kb/perfiles/previsional-CLAUDE.md`.
...
- [ ] Sección de alerta normativa de `kb/perfiles/previsional-CLAUDE.md` consultada (Paso 2)
...
- [ ] Liquidación remitida a la mecánica de `kb/ejemplos/ejemplos-previsional.md` con datos reales del caso
...
kb/perfiles/previsional-CLAUDE.md; liquidaciones en kb/ejemplos/ejemplos-previsional.md.*
