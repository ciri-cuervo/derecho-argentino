...
Antes de incluir cualquier cita legal, leer `kb/escritos/laboral/telegrama/reglas-normativas.md` y aplicar las reglas en orden.
...
Antes de redactar, leer `kb/escritos/laboral/telegrama/tipos-de-telegrama.md` y ubicar el grupo correspondiente. Luego leer el bloque de modelos que corresponda:

| Materia | Archivo |
|---|---|
| Registro de la relación laboral | `modelos/kb/escritos/laboral/telegrama/modelos/bloque-01-registro.md` |
| Estabilidad y despido | `modelos/kb/escritos/laboral/telegrama/modelos/bloque-02-estabilidad-despido.md` |
| Pago de salarios y remuneraciones | `modelos/kb/escritos/laboral/telegrama/modelos/bloque-03-salarios.md` |
| Modificaciones contractuales / ius variandi | `modelos/kb/escritos/laboral/telegrama/modelos/bloque-04-ius-variandi.md` |
| Renuncia | `modelos/kb/escritos/laboral/telegrama/modelos/bloque-05-renuncia.md` |
| Vacaciones y licencias | `modelos/kb/escritos/laboral/telegrama/modelos/bloque-06-vacaciones-licencias.md` |
| Seguridad y salud laboral / hostigamiento y discriminación | `modelos/kb/escritos/laboral/telegrama/modelos/bloque-07-salud-hostigamiento.md` |
| Industria de la construcción | `modelos/kb/escritos/laboral/telegrama/modelos/bloque-08-construccion.md` |
...
| "El modelo del bloque cubre el caso, no hace falta leer kb/escritos/laboral/telegrama/reglas-normativas.md" | Los modelos tienen notas de revisión, no verificación normativa automática. El Paso 2 es obligatorio siempre. Los modelos y las reglas son complementarios. |
...
- [ ] `kb/escritos/laboral/telegrama/reglas-normativas.md` consultado (Paso 2 ejecutado)
