# Glosario canónico de marcadores · derecho argentino
...
*Versión: 1.3 - agregado marcador B5 [VERIFICAR PRECEDENTE] (vigencia del precedente: confirmar que no fue dejado sin efecto ni superado; verificación manual, citados/citantes no implementado en el hub); usado en kb/transversales/bucles-SKILL.md y kb/transversales/fuentes-y-conectores.md*
*Versión: 1.2 - agregado marcador B4 [VERIFICAR CITA DE FALLOS] (holding verificado, cita formal pendiente); usado en kb/doctrina/penal-DOCTRINA.md*
