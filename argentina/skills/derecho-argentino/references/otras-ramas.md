...
| **Tributario** | **`references/tributario.md`, sección 33**, auditado contra la Ley 11.683 t.o. 1998 y con precedencia: prescripción, recursos del art. 76, clausura del art. 77 y demanda del art. 82. Quedan fuera la determinación de oficio, el régimen sancionatorio, la ejecución fiscal y los impuestos en particular, para lo que sigue `kb/perfiles/tributario-CLAUDE.md` (350 líneas) con la advertencia | El perfil incluye el procedimiento ante ARCA. **Se consolidó antes de la Ley 27.799 (BO 02/01/2026)**, que reescribió el art. 56: lo que diga sobre prescripción está vencido |
