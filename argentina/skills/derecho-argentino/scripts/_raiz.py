...
Dos disposiciones posibles, porque el marketplace publica el plugin desde argentina/:
...
def es_base(p: Path) -> bool:
    """True si p es la carpeta que contiene fuentes/ y kb/: argentina/ en el repo."""
    try:
